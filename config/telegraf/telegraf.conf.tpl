...
# ## DEPRECATED: The "logparser" plugin is deprecated in version 1.15.0 and will be removed in 1.35.0, use 'inputs.tail' with 'grok' data format instead.
# # Read metrics off Arista LANZ, via socket
# [[inputs.logparser]]
#   ## Log files to parse.
#   ## These accept standard unix glob matching rules, but with the addition of
